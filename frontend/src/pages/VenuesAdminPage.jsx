          ...
          {filteredClaims.map((claim) => (
            <article key={claim.id} className={`venue-card claim-card claim-status-${claim.status}`}>
              <div>
                ...
                <p className="meta-line">Tipo: {claim.requestType === "venue_update" ? "Alteração de dados da casa" : claim.requestType === "artist_inclusion" ? "Inclusão e reivindicação de artista" : claim.requestType === "team_access" ? claim.targetType === "venue" ? "Acesso à equipe da casa" : "Acesso à equipe do artista" : claim.targetType === "venue" ? "Reivindicação de propriedade da casa" : "Reivindicação de carteira"}</p>
