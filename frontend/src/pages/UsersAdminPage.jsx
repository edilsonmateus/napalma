...
export default function UsersAdminPage() {
  ...
  return <section className="screen users-admin-screen">
    ...
    <form className="clean-card users-admin-form" onSubmit={submit}>
      <div className="account-settings-section-title users-admin-section-heading"><div><span className="users-admin-section-heading__title"><UserPlus size={18} aria-hidden="true"/><strong>Novo usuário comum</strong></span><small>A função será sempre Usuário comum, sem privilégios administrativos.</small></div></div>
    ...
    <section className="clean-card users-admin-list privacy-admin-requests">
      <div className="account-settings-section-title users-admin-section-heading"><div><span className="users-admin-section-heading__title"><FileClock size={18} aria-hidden="true"/><strong>Solicitações de privacidade</strong></span><small>Pedidos de acesso, exportação, correção, anonimização ou exclusão enviados pelos usuários.</small></div></div>
    ...
    <section className="clean-card users-admin-list audit-log-list">
      <div className="account-settings-section-title users-admin-section-heading"><div><span className="users-admin-section-heading__title"><ScrollText size={18} aria-hidden="true"/><strong>Trilha de auditoria</strong></span><small>30 eventos sensiveis mais recentes. IPs, senhas, tokens e conteudos privados nao sao exibidos.</small></div></div>
    ...
    <section className="clean-card users-admin-list privacy-retention-preview">
      <div className="account-settings-section-title users-admin-section-heading"><div><span className="users-admin-section-heading__title"><Archive size={18} aria-hidden="true"/><strong>Prévia de retenção</strong></span><small>Inventário em modo seguro: nenhum dado é removido nesta tela.</small></div></div>
    ...
    <section className="clean-card users-admin-list security-readiness-list">
      <div className="account-settings-section-title users-admin-section-heading"><div><span className="users-admin-section-heading__title"><ShieldCheck size={18} aria-hidden="true"/><strong>Prontidão de segurança</strong></span><small>Diagnóstico administrativo sem exibir segredos, chaves ou valores de configuração.</small></div></div>
