...
export default function HistoryPage() {
  ...
  return (
    <section className="screen screen-history history-clean">
      ...
      {user && isError ? <p className="empty">Não foi possível carregar seu histórico.</p> : null}
      ...
      {user && !achievementsLoading && !achievementsError && achievements.length === 0 ? <p className="empty">Nenhuma conquista disponível ainda.</p> : null}
