...
export const env = {
  ...
  radarEventRemindersEnabled: process.env.RADAR_EVENT_REMINDERS_ENABLED === "true",
  radarEventReminderSchedulerEnabled: process.env.RADAR_EVENT_REMINDER_SCHEDULER_ENABLED !== "false",
  radarEventReminderSchedulerIntervalMs: Math.max(30000, Number(process.env.RADAR_EVENT_REMINDER_SCHEDULER_INTERVAL_MS || 60000)),
  radarEventReminderBatchSize: Math.max(1, Math.min(100, Number(process.env.RADAR_EVENT_REMINDER_BATCH_SIZE || 25))),
