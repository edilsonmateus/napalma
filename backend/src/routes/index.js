...
router.get("/me/legal-signatures", requireAuth, listMyLegalSignatures);
router.get("/me/legal-signatures/:participantId", requireAuth, getMyLegalSignature);
router.post("/me/legal-signatures/:participantId/request-code", requireAuth, privacySensitiveActionLimiter, requestMyLegalSignatureCode);
...
router.get("/admin/operations/documents", ...canManageLegalDocuments, listLegalDocuments);
router.get("/admin/operations/documents/:id/versions/:versionId/impact", ...canManageLegalDocuments, getLegalDocumentVersionImpact);
router.post("/admin/operations/documents/bootstrap", ...canManageLegalDocuments, bootstrapLegalDocumentCatalogue);
router.post("/admin/operations/documents", ...canManageLegalDocuments, createLegalDocument);
router.post("/admin/operations/documents/:id/versions", ...canManageLegalDocuments, createLegalDocumentVersion);
router.patch("/admin/operations/documents/:id/versions/:versionId/status", ...canManageLegalDocuments, transitionLegalDocumentVersion);
router.get("/admin/operations/signatures", ...canManageLegalDocuments, listOperationsLegalSignatures);
...
router.post("/me/claims", requireAuth, requireLegalDocumentAcceptance((req) => req.body?.targetType === "venue" ? "venue_claim" : "artist_claim"), claimsLimiter, createClaimRequest);
...
router.post("/me/advertiser-campaigns/:campaignId/creatives", requireAuth, requireLegalDocumentAcceptance("advertiser_campaign"), requireFeatureFlag("ADS_ADVERTISER_ACCOUNTS_ENABLED"), createMyAdvertiserCreative);
...
router.post("/me/advertiser-reviews/:entityType/:id/submit", requireAuth, requireLegalDocumentAcceptance("advertiser_campaign"), requireFeatureFlag("ADS_REVIEW_WORKFLOW_ENABLED"), submitMyAdvertiserReview);
...
router.post("/me/advertiser-accounts/:accountId/payment-orders", requireAuth, requireLegalDocumentAcceptance("patacos_purchase"), requireFeatureFlag("ADS_CREDITS_PURCHASE_ENABLED"), paymentLimiter, createMyPaymentOrder);
router.post("/me/advertiser-accounts/:accountId/wallet/allocate", requireAuth, requireLegalDocumentAcceptance("patacos_purchase"), requireFeatureFlag("ADS_CREDITS_PURCHASE_ENABLED"), paymentLimiter, allocateMyWalletCredits);
